<?php 
	...
	include 'model/admin/chitietdat_model.php';
	include 'model/admin/hanhkhach_model.php';
	...
	class HomeController {
		...
		public function handleReqquest() {
			...
			} elseif($controller == 'chitietdat') {
				switch ($action) {
					case 'tourdat':
						// lay thong tin trang chu
						// Model lay thong tin trang chu
						$chitietdatModel = new chitietdatModel();
						$result = $chitietdatModel->listChitietdat();
						//Do du lieu ra views
						include 'views/pages/admin/tour/tourdat.php';
						break;
					case 'tourdat1':
						// lay thong tin trang chu
						// Model lay thong tin trang chu
						$chitietdatModel = new chitietdatModel();
						$result = $chitietdatModel->listChitietdat1();
						//Do du lieu ra views
						include 'views/pages/admin/tour/tourdat1.php';
						break;
					case 'delete':
						$id = $_GET['id'];
						$chitietdatModel = new chitietdatModel();
						$chitietdatModel->delete($id);
						break;
					case 'delete1':
						$id = $_GET['id'];
						$chitietdatModel = new chitietdatModel();
						$chitietdatModel->delete1($id);
						break;
					case 'xacnhandat':
						if (isset($_POST['xacnhandat'])) {
					    $id = $_GET['id'];
						$xacnhan = $_POST['xacnhan'];
						$chitietdatModel = new chitietdatModel();
						$chitietdatModel->xacnhandat($xacnhan,$id);
						}
						include 'views/pages/admin/tour/xacnhandat.php';
						break;
					case 'xacnhandat1':
						if (isset($_POST['xacnhandat'])) {
					    $id = $_GET['id'];
						$xacnhan = $_POST['xacnhan'];
						$chitietdatModel = new chitietdatModel();
						$chitietdatModel->xacnhandat1($xacnhan,$id);
						}
						include 'views/pages/admin/tour/xacnhandat1.php';
						break;
					// case 'reply':
					// 	if (isset($_POST['reply_cmt'])) {
					//     $id = $_GET['id'];
			...
			} elseif ($controller == 'hanhkhach') {
				switch ($action) {
					case 'listHK':
						$hkhachtModel = new hkhachtModel();
						$result = $hkhachtModel->listHK();
						include 'views/pages/admin/hanhkhach/list_hanhkhach.php';
						break;
					case 'delete':
					    $id = $_GET['id'];
						$hkhachtModel = new hkhachtModel();
						$result = $hkhachtModel->delete($id);
						break;
					default:
						# code...
						break;
