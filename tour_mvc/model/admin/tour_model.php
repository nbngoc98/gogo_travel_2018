<?php 
	class tourModel extends connectDB {
		...
		public function edit_tour($MaTour,$MaLoai,$TenTour,$tgian,$NoiDungTour,$imageName,$GiaNguoiLon,$GiaTreEm,$DiemKhoiHanh,$id){
			$sql = "UPDATE tour SET MaTour=$MaTour,MaLoai=$MaLoai,TenTour='$TenTour',tgian='$tgian',NoiDungTour='$NoiDungTour', GiaNguoiLon=$GiaNguoiLon, GiaTreEm=$GiaTreEm, DiemKhoiHanh='$DiemKhoiHanh' WHERE MaTour=$id";
			// mysqli_query($this->connect(), $sql);
		    ...
		    if (!$imageUpload['error']) {
		        ...
		        unlink($imasgeEdit);
		        $sql = "UPDATE tour SET AnhTour='$imageName' WHERE MaTour=$id";
				mysqli_query($this->connect(), $sql);
		    }
