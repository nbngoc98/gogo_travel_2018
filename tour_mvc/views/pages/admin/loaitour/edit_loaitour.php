      ...
      <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Sửa tên loại tour</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <button type="submit" class="btn btn-block btn-primary btn-lg" name="edit_loaitour">Cập nhật</button>
