      ...
      <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Thêm ngày khởi hành</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" name="AddSale" action="#" method="post" enctype="multipart/form-data">
                ...
                <div class="box-body">
                  <div class="row">
                    <div class="col-xs-8"><label>Loại Tour:</label>
              ...
              <button type="submit" class="btn btn-block btn-primary btn-lg" name="add_date">Thêm vào</button>
