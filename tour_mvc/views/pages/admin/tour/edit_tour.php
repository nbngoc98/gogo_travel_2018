        ...
        <div class="col-xs-12">
            ...
            <div class="box-body">
              <form role="form" name="AddSale" action="#" method="post" enctype="multipart/form-data">
                ...
                <div class="box-body">
                  <div class="row">
                    <div class="col-xs-1"><label>IDales:</label>
                    ...
                    <div class="col-xs-5"><label>Thời gian đi:</label>
              ...
              <button type="submit" class="btn btn-block btn-primary btn-lg" name="edit_tour">Cập nhật</button>
