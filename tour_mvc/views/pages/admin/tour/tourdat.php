  ...
  <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">Tour Du Lịch Thường</h3>
      ...
      if ($result->num_rows > 0) {
         echo"
                    <tr style='width: 100%'>
                      ...
                      <th style='width: 12%'>Departure Day</th>
        ...
        while ($row = $result->fetch_assoc()) {
          ...
          echo"    
                      <td><a href='admin.php?controller=chitietdat&action=delete&id=$id'><i class='fa fa-fw fa-close'></i></a></td>";

                      if ($xacnhandat == '0') {
                              echo "<td><a href='admin.php?controller=chitietdat&action=xacnhandat&id=$id'><button type='button' class='btn btn-block btn-warning' style='font-size: 10px;'>Xác nhận</button></a></td>";
                            }else{
