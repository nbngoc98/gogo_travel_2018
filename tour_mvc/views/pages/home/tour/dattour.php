                        ...
                        <div class="row tour-info-right-frame2">
                            <div class="col-xs-12">
                                ...
                                <div class="row" style="margin-bottom: 16px; margin-top: 15px">
                                    ...
                                    <?php echo "<div class='col-md-3 col-sm-5 col-xs-12'><a href='index.php?controller=ngaykhac&action=date&id=$id'><i class='fa fa-calendar'></i>&nbsp;&nbsp;<span style='color: #fc6600'>Ngày khác</span></a></div>";?>  
                                </div>
