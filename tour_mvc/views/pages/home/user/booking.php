                    ...
                    <div class="dashboard-wrapper">
                    	<div class="row">
                            ...
                            <div class="col-xs-12 col-sm-10 col-md-10 dashboard-content booking-trips">
                                ...
                                <button class="tablink" onclick="openPage('Home', this, '#faa61a')" id="defaultOpen">Tour Du Lịch</button>
                                <a href="index.php?controller=users&action=booking2" style="color: white"><button class="tablink" onclick="openPage('News', this, '#faa61a')" >Tour Khuyến Mãi</button></a>
                                                            ...
                                                            while ($row = $result->fetch_assoc()) {
                                                                ...
                                                                echo"
                                                                   <tr>
                                                                        ...
                                                                        <td class='dash-list-btn'><a href='index.php?controller=users&action=huytour&id=$id'><button class='btn btn-orange'>Hủy</button></a></td>
                                                                    </tr>
                                                                ";                                    
                                                            }
                                                        } else {
